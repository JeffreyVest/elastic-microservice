...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/GuassRand.js":[function(require,module,exports) {
"use strict";
...
var scaleAcc = d3.scaleLinear().domain([0, 1]).range([-2, 2]);
exports.scaleAcc = scaleAcc;
var scaleColor = d3.scaleSequential(d3.interpolateBlues);
exports.scaleColor = scaleColor;
},{"d3":"node_modules/d3/index.js"}],"src/Blobby.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.Blobby = void 0;

var _GuassRand = require("./GuassRand");
...
/*#__PURE__*/
function () {
  function Blobby(size, canvas, ctx, fillStyle) {
    _classCallCheck(this, Blobby);
  ...
  _createClass(Blobby, [{
    ...
    value: function updateRandom() {
      this.acc = [(0, _Scales.scaleAcc)((0, _GuassRand.gaussianRand)()), (0, _Scales.scaleAcc)((0, _GuassRand.gaussianRand)())];
      this.updatePos();
    }
  }, {
    key: "updateMouse",
    ...
    value: function updatePos() {
      ...
      this.bounce(0, 0, function (p, c) {
        return p < c;
      });
      this.bounce(0, this.canvas.width, function (p, c) {
        return p > c;
      });
      this.bounce(1, 0, function (p, c) {
        return p < c;
      });
      this.bounce(1, this.canvas.height, function (p, c) {
        return p > c;
      });
    }
  }, {
    key: "bounce",
    value: function bounce(i, cutoff, compare) {
...
exports.Blobby = Blobby;
},{"./GuassRand":"src/GuassRand.js","./Scales":"src/Scales.js"}],"src/index.js":[function(require,module,exports) {
"use strict";
...
var blobby = new _Blobby.Blobby(10, canvas, ctx, "black");
var state = {
  left: false,
  right: false,
  up: false,
